/**
 * D bindings for the Wren programming language.
 *
 * License:
...
alias WrenLoadModuleFn = char* function(WrenVM* vm, const(char)* name);
...
WrenValue* wrenGetMethod(WrenVM* vm, const(char)* module_, const(char)* variable,
                         const(char)* signature);
